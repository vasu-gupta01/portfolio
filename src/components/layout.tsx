    ...
    <div className="flex flex-col h-full dark:bg-[#00303D] subpixel-antialiased">
      ...
      <footer className="flex flex-row flex-wrap justify-center items-center py-4 text-sm font-medium font-mono">
        ...
        <div className="flex flex-row xl:hidden mx-8">
          ...
          >
            <svg
              className="fill-[#002029] dark:fill-[#00607A] w-6 h-6 m-4 hover:fill-[#00607A] dark:hover:fill-[#5FD3C6]  hover:-translate-y-1 transition-color duration-200 ease-in-out"
              role="img"
              viewBox="0 0 24 24"
          ...
          <a
            href="/PunarVasuGupta-Resume2022.pdf"
            target="_blank"
            rel="noreferrer"
          >
            <svg
